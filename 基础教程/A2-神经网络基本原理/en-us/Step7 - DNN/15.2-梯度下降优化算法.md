...
![](https://aiedugithub4a2.blob.core.windows.net/a2-images/Images/15/sgd_algorithm.png" />
...
|学习率|损失函数与准确率|
|---|---|
|0.1|![](https://aiedugithub4a2.blob.core.windows.net/a2-images\Images\15\op_sgd_ch09_loss_01.png">|
|0.3|![](https://aiedugithub4a2.blob.core.windows.net/a2-images\Images\15\op_sgd_ch09_loss_03.png">|
...
![](https://aiedugithub4a2.blob.core.windows.net/a2-images/Images/15/momentum_algorithm.png" />
...
|算法|损失函数和准确率|
|---|---|
|SGD|![](https://aiedugithub4a2.blob.core.windows.net/a2-images\Images\15\op_sgd_ch09_loss_01.png">|
|Momentum|![](https://aiedugithub4a2.blob.core.windows.net/a2-images\Images\15\op_momentum_ch09_loss_01.png">|
...
![](https://aiedugithub4a2.blob.core.windows.net/a2-images/Images/15/nag_algorithm.png)
...
|---|---|
|Momentum|![](https://aiedugithub4a2.blob.core.windows.net/a2-images\Images\15\op_momentum_ch09_loss_01.png">|
|NAG|![](https://aiedugithub4a2.blob.core.windows.net/a2-images\Images\15\op_nag_ch09_loss_01.png">|
